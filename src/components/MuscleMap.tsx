...
const FRONT: Shape[] = [
  ...
  // 大胸筋を上部/中部/下部の3バンドに
  { m: 'chest_upper', pts: [[60.5, 37], [71, 39], [71, 43.5], [60.5, 43.5]] },
  { m: 'chest_mid', pts: [[60.5, 43.5], [71.5, 43.5], [72, 50], [60.5, 50]] },
  { m: 'chest_lower', pts: [[60.5, 50], [72, 50], [71.5, 58], [60.5, 58.5]] },
  // 上腕二頭筋を長頭(外側)/短頭(内側)に
  { m: 'biceps_short', pts: [[75, 49], [79, 50.5], [80, 65], [76, 65]] },
  { m: 'biceps_long', pts: [[79, 50.5], [82, 52], [83, 66], [80, 65]] },
  { m: 'forearms', pts: [[77, 67], [84, 70], [87, 87], [80, 88]] },
  { m: 'obliques', pts: [[66, 61], [72, 64], [71, 90], [66, 92]] },
  // 腹直筋を上部/下部に
  { m: 'abs_upper', center: true, pts: [[54.5, 60], [65.5, 60], [65.5, 77], [54.5, 77]] },
  { m: 'abs_lower', center: true, pts: [[54.5, 77], [65.5, 77], [65.5, 95], [54.5, 95]] },
  // 大腿四頭筋を内側広筋/大腿直筋/外側広筋の3つに
  { m: 'quads_inner', pts: [[59, 99], [63, 99], [62, 135], [59, 135]] },
  { m: 'quads_rectus', pts: [[63, 99], [67, 99], [66, 135], [62, 135]] },
  { m: 'quads_outer', pts: [[67, 99], [71, 98], [69, 135], [66, 135]] },
  { m: 'adductors', pts: [[54, 98], [59, 98], [59, 128], [56, 123]] },
];

// 背面（ローカル中心 x=60）
const BACK: Shape[] = [
  // 僧帽筋を上部/中部下部に
  { m: 'traps_upper', center: true, pts: [[51, 31], [60, 28], [69, 31], [67, 38], [53, 38]] },
  { m: 'traps_mid', center: true, pts: [[53, 38], [67, 38], [66, 47], [60, 49], [54, 47]] },
  { m: 'rear_delt', pts: [[69, 34], [79, 37], [80, 45], [70, 45]] },
  { m: 'lats', pts: [[60.5, 48], [71, 49], [70, 69], [60.5, 66]] },
  // 上腕三頭筋を長頭(内側)/外側頭(外側)/内側頭(下部)に
  { m: 'triceps_long', pts: [[75, 49], [79, 50.5], [79, 59.5], [76, 59.5]] },
  { m: 'triceps_lateral', pts: [[79, 50.5], [82, 52], [82.5, 59.5], [79, 59.5]] },
  { m: 'triceps_medial', pts: [[76, 59.5], [82.5, 59.5], [83, 66], [76, 65]] },
  { m: 'forearms', pts: [[77, 67], [84, 70], [87, 87], [80, 88]] },
  { m: 'lower_back', center: true, pts: [[55, 69], [65, 69], [64, 84], [56, 84]] },
  { m: 'glutes', pts: [[60.5, 85], [71, 86], [71.5, 101], [60.5, 100]] },
  // ハムストリングを大腿二頭筋(外側)/半腱・半膜様筋(内側)に
  { m: 'hamstrings_inner', pts: [[59, 103], [65, 103], [64, 135], [59, 135]] },
  { m: 'hamstrings_outer', pts: [[65, 103], [71, 102], [69, 135], [64, 135]] },
  // 下腿を腓腹筋/ヒラメ筋に
  { m: 'calves_gastro', pts: [[61, 147], [70, 147], [69, 166], [61, 166]] },
  { m: 'calves_soleus', pts: [[61, 166], [69, 166], [68, 184], [61.5, 184]] },
];
